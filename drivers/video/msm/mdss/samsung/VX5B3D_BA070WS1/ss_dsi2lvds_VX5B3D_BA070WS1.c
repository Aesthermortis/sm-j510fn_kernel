...
#define V5D3BX_10KHZ_DEFAULT_RATIO	0x550
...
static void mdss_lvds_data_ql(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	vdd->panel_func.samsung_lvds_write_reg(0x704, 0x30319);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x128, 0x104010);
	vdd->panel_func.samsung_lvds_write_reg(0x12C, 0xD0);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x174, 0xff);
	...
	vdd->panel_func.samsung_lvds_write_reg(0x258, 0x20008);
...
static void mdss_lvds_data_ql2(struct samsung_display_driver_data *vdd)
{
	...
	msleep(5);
		/*pwm freq 10khz*/
	vdd->panel_func.samsung_lvds_write_reg(0x160, 0x550);
